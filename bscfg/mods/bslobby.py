...
def __init__(self, vPos, player, lobby):
    ...
    bsUtils.animateArray(self.icon, 'scale', 2, {0: (45, 45)})
    ...
    self._Modify_UpdateFromPlayer_Profile()
    try:
...
def _Modify_UpdateFromPlayer_Profile(self):
...
bsLobby.Chooser.getGlowingColors = getGlowingColors
bsLobby.Chooser.updateFromPlayerProfile = _Modify_UpdateFromPlayer_Profile
bsLobby.Chooser._Modify_UpdateFromPlayer_Profile = _Modify_UpdateFromPlayer_Profile
